...
```
    cd "Watson.Lambda.ToneAnalyzer"
    dotnet restore
```

Execute unit tests
```
    cd "Watson.Lambda.ToneAnalyzer/test/Watson.Lambda.ToneAnalyzer.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "Watson.Lambda.ToneAnalyzer/src/Watson.Lambda.ToneAnalyzer"
