...
```
    cd "Watson.Lambda.PersonalInsights"
    dotnet restore
```

Execute unit tests
```
    cd "Watson.Lambda.PersonalInsights/test/Watson.Lambda.PersonalInsights.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "Watson.Lambda.PersonalInsights/src/Watson.Lambda.PersonalInsights"
